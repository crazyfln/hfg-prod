...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacilityMessage.read_by_manager'
        db.add_column(u'app_facilitymessage', 'read_by_manager',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FacilityMessage.read_by_provider'
        db.add_column(u'app_facilitymessage', 'read_by_provider',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'FacilityMessage.read_by_manager'
        db.delete_column(u'app_facilitymessage', 'read_by_manager')

        # Deleting field 'FacilityMessage.read_by_provider'
        db.delete_column(u'app_facilitymessage', 'read_by_provider')
