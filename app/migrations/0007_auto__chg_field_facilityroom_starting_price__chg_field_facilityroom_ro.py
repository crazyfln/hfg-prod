...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FacilityRoom.starting_price'
        db.alter_column(u'app_facilityroom', 'starting_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

        # Changing field 'FacilityRoom.room_type'
        db.alter_column(u'app_facilityroom', 'room_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.RoomType'], null=True))

        # Changing field 'FacilityRoom.width'
        db.alter_column(u'app_facilityroom', 'width', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

        # Changing field 'FacilityRoom.length'
        db.alter_column(u'app_facilityroom', 'length', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

    def backwards(self, orm):

        # Changing field 'FacilityRoom.starting_price'
        db.alter_column(u'app_facilityroom', 'starting_price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=15, decimal_places=2))

        # User chose to not deal with backwards NULL issues for 'FacilityRoom.room_type'
        raise RuntimeError("Cannot reverse this migration. 'FacilityRoom.room_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'FacilityRoom.room_type'
        db.alter_column(u'app_facilityroom', 'room_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.RoomType']))

        # Changing field 'FacilityRoom.width'
        db.alter_column(u'app_facilityroom', 'width', self.gf('django.db.models.fields.CharField')(default='0', max_length=5))

        # Changing field 'FacilityRoom.length'
        db.alter_column(u'app_facilityroom', 'length', self.gf('django.db.models.fields.CharField')(default='0', max_length=5))
