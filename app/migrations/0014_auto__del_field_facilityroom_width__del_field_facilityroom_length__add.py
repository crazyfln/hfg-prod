...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FacilityRoom.width'
        db.delete_column(u'app_facilityroom', 'width')

        # Deleting field 'FacilityRoom.length'
        db.delete_column(u'app_facilityroom', 'length')

        # Adding field 'FacilityRoom.area'
        db.add_column(u'app_facilityroom', 'area',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FacilityRoom.width'
        db.add_column(u'app_facilityroom', 'width',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FacilityRoom.length'
        db.add_column(u'app_facilityroom', 'length',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'FacilityRoom.area'
        db.delete_column(u'app_facilityroom', 'area')
    ...
    models = {
        ...
        u'account.user': {
            ...
            'preferred_contact': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
        ...
        u'app.facilitymessage': {
            ...
            'planned_move_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'preferred_contact': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'read_by_manager': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'read_by_provider': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'app.facilityroom': {
            ...
            'area': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'facility': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.Facility']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
