...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Facility.manager_note'
        db.alter_column(u'app_facility', 'manager_note', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

    def backwards(self, orm):

        # Changing field 'Facility.manager_note'
        db.alter_column(u'app_facility', 'manager_note', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))
