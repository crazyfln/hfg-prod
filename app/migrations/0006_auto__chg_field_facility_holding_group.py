...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Facility.holding_group'
        db.alter_column(u'app_facility', 'holding_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.HoldingGroup'], null=True))

    def backwards(self, orm):

        # Changing field 'Facility.holding_group'
        db.alter_column(u'app_facility', 'holding_group_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['account.HoldingGroup']))
