...
class SearchForm(forms.Form):
    ...
    min_value = forms.IntegerField(widget=forms.HiddenInput(), initial=SEARCH_MIN_VAL_INITIAL)
    max_value = forms.IntegerField(widget=forms.HiddenInput(), initial=SEARCH_MAX_VAL_INITIAL)
