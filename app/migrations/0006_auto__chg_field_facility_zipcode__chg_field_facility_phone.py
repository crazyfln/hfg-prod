...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Facility.zipcode'
        db.alter_column(u'app_facility', 'zipcode', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Facility.phone'
        db.alter_column(u'app_facility', 'phone', self.gf('django.db.models.fields.CharField')(max_length=7))

    def backwards(self, orm):

        # Changing field 'Facility.zipcode'
        db.alter_column(u'app_facility', 'zipcode', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Facility.phone'
        db.alter_column(u'app_facility', 'phone', self.gf('django.db.models.fields.IntegerField')())
