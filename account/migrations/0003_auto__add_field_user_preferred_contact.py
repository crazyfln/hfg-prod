...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.preferred_contact'
        db.add_column(u'account_user', 'preferred_contact',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.preferred_contact'
        db.delete_column(u'account_user', 'preferred_contact')
