...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Facility.vacancies_updated'
        db.add_column(u'app_facility', 'vacancies_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 8, 13, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Facility.vacancies_updated'
        db.delete_column(u'app_facility', 'vacancies_updated')
