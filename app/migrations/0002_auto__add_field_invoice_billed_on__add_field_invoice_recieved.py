...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.billed_on'
        db.add_column(u'app_invoice', 'billed_on',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 16, 0, 0)),
                      keep_default=False)

        # Adding field 'Invoice.recieved'
        db.add_column(u'app_invoice', 'recieved',
    ...
    def backwards(self, orm):
        # Deleting field 'Invoice.billed_on'
        db.delete_column(u'app_invoice', 'billed_on')

        # Deleting field 'Invoice.recieved'
        db.delete_column(u'app_invoice', 'recieved')
