...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'app_facility', 'min_price', self.gf('django.db.models.fields.CharField')(max_length=15))
    ...
    models = {
        ...
        u'app.facility': {
            ...
            'min_price': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '15', 'blank': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
