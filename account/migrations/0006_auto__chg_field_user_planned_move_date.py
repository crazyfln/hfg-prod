...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.planned_move_date'
        db.alter_column(u'account_user', 'planned_move_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'User.planned_move_date'
        db.alter_column(u'account_user', 'planned_move_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
