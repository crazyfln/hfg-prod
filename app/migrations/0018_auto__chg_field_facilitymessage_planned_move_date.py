...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FacilityMessage.planned_move_date'
        db.alter_column(u'app_facilitymessage', 'planned_move_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'FacilityMessage.planned_move_date'
        db.alter_column(u'app_facilitymessage', 'planned_move_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        u'account.user': {
            ...
            'planned_move_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'app.facility': {
            ...
            'vacancies_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
