...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Facility.latitude'
        db.alter_column(u'app_facility', 'latitude', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Facility.longitude'
        db.alter_column(u'app_facility', 'longitude', self.gf('django.db.models.fields.IntegerField')())
