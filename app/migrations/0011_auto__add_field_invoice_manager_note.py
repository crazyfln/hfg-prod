...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.manager_note'
        db.add_column(u'app_invoice', 'manager_note',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.manager_note'
        db.delete_column(u'app_invoice', 'manager_note')
