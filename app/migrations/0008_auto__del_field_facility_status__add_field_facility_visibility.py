...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Facility.status'
        db.delete_column(u'app_facility', 'status')

        # Adding field 'Facility.visibility'
        db.add_column(u'app_facility', 'visibility',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Facility.status'
        db.add_column(u'app_facility', 'status',
                      self.gf('django.db.models.fields.CharField')(default='Vacancies', max_length='20'),
                      keep_default=False)

        # Deleting field 'Facility.visibility'
        db.delete_column(u'app_facility', 'visibility')
